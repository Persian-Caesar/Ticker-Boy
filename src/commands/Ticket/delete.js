...
module.exports = {
  ...
  run: async (client, interaction, args, lang, prefix) => {
    ...
    let message = {
      ...
      components: [new ActionRowBuilder().addComponents(new ButtonBuilder().setStyle(ButtonStyle.Secondary).setCustomId("cancel").setEmoji(client.emotes.x).setLabel("Don't Delete"), new ButtonBuilder().setStyle(ButtonStyle.Danger).setCustomId("ticket-deleteTicket").setEmoji(client.emotes.trash).setLabel("Delete It"))]
    };
